...
function validateForm(){
	...
	if(document.getElementById("existingDoc").value.trim() === ""){
...
let qualificationBranch = {

"Intermediate": ["MPC","BIPC","CEC","MEC","HEC"],

"Diploma": ["Mechanical","Civil","EEE","ECE","CSE","Chemical"],

"B.Tech": ["CSE","IT","ECE","EEE","Mechanical","Civil","Chemical"],

"B.Sc": ["Physics","Chemistry","Mathematics","Computer Science","Biotechnology"],

"B.Com": ["General","Computers","Accounting"],

"B.A": ["History","Economics","Political Science"],

"MCA": ["Computer Applications"],

"M.Tech": ["CSE","VLSI","Structural","Thermal","Power Systems"],
...
let selectedQualification = this.value;
let branchSelect = document.getElementById("branch");

branchSelect.innerHTML = "<option value=''>Select Branch</option>";

if(qualificationBranch[selectedQualification]){

qualificationBranch[selectedQualification].forEach(function(branch){
...
fetch("<%=request.getContextPath()%>/js/states-districts.json")
.then(function(response){
    return response.json();
})
.then(function(data){
    stateDistrictData = data.states;
})
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    stateSelect.addEventListener("change", function(){
        ...
        stateDistrictData.forEach(function(item){
